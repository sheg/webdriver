 ...
 */
public class TestAMSLivePlayerSetSettingsVideoSize400x325AutoOff extends TestCase {
   ...
   */
  @Test
  public void testChangeContentTypeSettingsToVideoSize400x325AutoOff () throws Exception {
