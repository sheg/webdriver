 ...
 */
public class TestAMSDeleteSuccessfullManualPlaylist extends TestCase {

  /**
   * <b>Test</b><br>
   * Test to successfully delete a Manual Playlist
   *
   * @throws Exception
   */
  @Test
  public void testSuccessfullyDeleteManualPlaylist() throws Exception {
