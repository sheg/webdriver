 ...
 */
public class TestAMSLivePlayerSetSettingsVideoSize320x265AutoOn extends TestCase {
   ...
   */
  @Test
  public void testChangeContentTypeSettingsToVideoSize320x265AutoOn () throws Exception {
