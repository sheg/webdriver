 ...
 */
public class TestAMSLivePlayerSetSettingsVideoSize320x265AutoOff extends TestCase {
   ...
   */
  @Test
  public void testChangeContentTypeSettingsToVideoSize320x265AutoOff () throws Exception {
